...
namespace FurnitureShopDatabaseImplement
{
    public class FurnitureShopDatabase : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) 
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-1PF8O2J\SQLEXPRESS;Initial Catalog=FurnitureShopDatabase;Integrated Security=True;MultipleActiveResultSets=True;");
            } 
